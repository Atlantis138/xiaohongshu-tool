...
from .extractors import EXTRACT_NOTE_JS, EXTRACT_SEARCH_ITEMS_JS
...
def _click_search_item(page: Page, item: SearchItem) -> bool:
...
def scrape_keyword_previews(
    ...
    for round_index in range(1, args.max_scrolls + 1):
        ...
        for item in scan_items:
            ...
            try:
                if not _click_search_item(page, item):
                    row["status"] = "error"
